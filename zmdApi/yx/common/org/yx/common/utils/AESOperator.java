...
public class AESOperator {
     ...
     */
    private static final String sKey = "sesameapi2017227";//key，可自行修改
    ...
    public static void main(String[] args) throws Exception {
        ...
        String DeString = AESOperator.getInstance().decrypt("zdVciVqtR2aplhajw6pG+w==");
